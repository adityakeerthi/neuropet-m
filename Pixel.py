...
class Pixel:
    def __init__(self, position, tracers):
    ...
    def RedMeanEuclidean(self, C1, C2):
    ...
    def RGB_to_Concentration(self, rgb):
        ...
        for level in mined:
            ...
            Δc = self.RedMeanEuclidean(c1, c2)
    ...
    def Add_Concentration(self, tracer, rgb):
        self.concentration[tracer] = self.RGB_to_Concentration( [rgb[0], rgb[1], rgb[2] ])
        return self.concentration[tracer]

# pixel = Pixel(['AV45', 'PIB'], { "x": 0, "y": 0, "z": 0 })
# pixel.RGB_to_Concentration([255, 0, 0])